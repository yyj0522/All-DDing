    ...
    switch (id) {
      ...
      case 'oceanTrade':
        return {
          title: '해양 종합 거래 계산기',
          content: isMain ? (
            <div className="-mx-2 px-2"><OceanTradeCalcTab userStats={userStats} toolImprints={{}} /></div>
          ) : (
            <div className="flex flex-col h-full items-center justify-center text-center">
        ...
        return {
          ...
          content: isMain ? (
            <div className="flex flex-col items-center justify-center text-center p-6">
               ...
               <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-3">Timer-Mod v1.0.6</h3>
               ...
               <div className="flex flex-col sm:flex-row gap-4 w-full max-w-lg">
                 <a href="https://raw.githubusercontent.com/yyj0522/alldding-assets/main/files/timermod-fabric-1.0.6.jar" className="flex-1 bg-rose-600 hover:bg-rose-500 text-white font-black py-4 rounded-2xl transition-colors shadow-lg shadow-rose-500/20 flex items-center justify-center gap-2 text-lg">Fabric 다운로드</a>
                 <a href="https://raw.githubusercontent.com/yyj0522/alldding-assets/main/files/timermod-neoforge-1.0.6.jar" className="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white font-black py-4 rounded-2xl transition-colors shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2 text-lg">NeoForge 다운로드</a>
               </div>
            </div>
          ) : (
            <div className="flex flex-col h-full items-center justify-center text-center">
              ...
              <div className="mt-auto w-full grid grid-cols-2 gap-2">
                <a href="https://raw.githubusercontent.com/yyj0522/alldding-assets/main/files/timermod-fabric-1.0.6.jar" className="bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 text-gray-900 dark:text-white py-2 rounded-lg text-[11px] font-bold transition-colors">Fabric 용</a>
                <a href="https://raw.githubusercontent.com/yyj0522/alldding-assets/main/files/timermod-neoforge-1.0.6.jar" className="bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 text-gray-900 dark:text-white py-2 rounded-lg text-[11px] font-bold transition-colors">NeoForge 용</a>
              </div>
            </div>
          )
        };
