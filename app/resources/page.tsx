      ...
      <main className="relative z-10 flex-1 max-w-4xl w-full mx-auto px-4 pt-28 md:pt-40 pb-24 md:pb-20">
        ...
        <div className="bg-white dark:bg-[#0a0a0a] border border-gray-300 dark:border-transparent rounded-[2rem] p-6 md:p-8 transition-all duration-500 shadow-md dark:shadow-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-16">
          ...
          <div className="w-full md:w-auto flex flex-col sm:flex-row gap-3">
            <button 
              onClick={() => handleDownload('fabric', 'https://raw.githubusercontent.com/yyj0522/alldding-assets/main/files/timermod-fabric-1.0.6.jar', 'timermod-fabric-1.0.6.jar')}
            ...
            <button 
              onClick={() => handleDownload('neoforge', 'https://raw.githubusercontent.com/yyj0522/alldding-assets/main/files/timermod-neoforge-1.0.6.jar', 'timermod-neoforge-1.0.6.jar')}
          ...
          <section className="bg-white dark:bg-[#0a0a0a] border border-gray-300 dark:border-transparent rounded-[2rem] p-6 md:p-8 shadow-md dark:shadow-2xl transition-colors">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm md:text-base font-bold transition-colors pl-2">
                다운로드 받은 <code className="bg-gray-100 dark:bg-[#111113] border border-gray-300 dark:border-transparent px-2 py-0.5 rounded-md text-cyan-600 dark:text-cyan-400 transition-colors mx-1">timermod-fabric-1.0.6.jar</code> 또는 <code className="bg-gray-100 dark:bg-[#111113] border border-gray-300 dark:border-transparent px-2 py-0.5 rounded-md text-emerald-600 dark:text-emerald-400 transition-colors mx-1">timermod-neoforge-1.0.6.jar</code> 파일을 본인이 사용하는 로더(Fabric/NeoForge)에 맞춰 마인크래프트 설치 폴더 내의 <code className="bg-gray-100 dark:bg-[#111113] border border-gray-300 dark:border-transparent px-2 py-0.5 rounded-md text-cyan-600 dark:text-cyan-400 transition-colors mx-1">mods</code> 폴더에 넣어주세요. 패브릭 환경의 경우 <code className="bg-gray-100 dark:bg-[#111113] border border-gray-300 dark:border-transparent px-2 py-0.5 rounded-md text-cyan-600 dark:text-cyan-400 transition-colors mx-1">Fabric api</code> 파일이 함께 설치되어 있어야 정상 작동합니다. 오류나 적용이 안된다면 하단 의견남기기를 해주시면 최대한 빠른 답장 드리겠습니다.
              </p>
