  ...
  return (
    <>
      <div className="fixed top-4 md:top-6 left-0 right-0 z-[60] flex justify-center px-4">
        <nav className="flex items-center justify-between w-full max-w-6xl px-6 py-3 bg-slate-50/95 dark:bg-zinc-800/95 border-2 border-b-4 border-slate-200 dark:border-zinc-700 backdrop-blur-xl rounded-2xl shadow-[4px_4px_0_rgba(0,0,0,0.05)] dark:shadow-[4px_4px_0_rgba(0,0,0,0.3)] transition-colors">
