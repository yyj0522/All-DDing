...
const EFFECTS_DATA: Record<string, { name: string; maxLevel: number; reqs: number[] }[]> = {
  hoe: [
    ...
    { name: '빠른 농부', maxLevel: 3, reqs: [9, 11, 14] },
    { name: '작물 상자', maxLevel: 5, reqs: [7, 9, 9, 11, 11] },
    { name: '과일 바구니', maxLevel: 5, reqs: [9, 11, 11, 14, 14] },
    { name: '유성 낙하', maxLevel: 5, reqs: [9, 11, 11, 14, 14] },
    { name: '농부 룰렛', maxLevel: 5, reqs: [5, 7, 7, 9, 9] },
  ],
  pickaxe: [
    ...
    { name: '빠른 광부', maxLevel: 3, reqs: [9, 11, 14] },
    { name: '보석 코비', maxLevel: 5, reqs: [9, 11, 11, 14, 14] },
    { name: '광산 수레', maxLevel: 5, reqs: [7, 9, 9, 11, 11] },
    { name: '광부 룰렛', maxLevel: 5, reqs: [5, 7, 7, 9, 9] },
  ],
  rod: [
    ...
    { name: '수중 호흡', maxLevel: 1, reqs: [11] },
    { name: '빠른 어부', maxLevel: 3, reqs: [9, 11, 14] },
    { name: '정령 고래', maxLevel: 5, reqs: [7, 9, 9, 11, 11] },
    { name: '가오리 인도', maxLevel: 5, reqs: [9, 11, 11, 14, 14] },
    { name: '어부 룰렛', maxLevel: 5, reqs: [5, 7, 7, 9, 9] },
  ],
  sword: [
    ...
    { name: '빠른 사냥꾼', maxLevel: 3, reqs: [9, 11, 14] },
    { name: '흔적 추적', maxLevel: 5, reqs: [7, 9, 9, 11, 11] },
    { name: '조각 공명', maxLevel: 5, reqs: [9, 11, 11, 14, 14] },
    { name: '흡인 사냥', maxLevel: 5, reqs: [9, 11, 11, 14, 14] },
    { name: '사냥꾼 룰렛', maxLevel: 5, reqs: [5, 7, 7, 9, 9] },
  ]
};
