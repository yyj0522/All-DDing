...
const BADGE_REWARDS: Reward[] = [
  ...
  { id: 'badge33', name: '숲지기의 망토 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge33.png`, amount: 1, grade: 'mythic', effect: '비행속도1' },
  { id: 'badge34', name: '요정의 날개 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge34.png`, amount: 1, grade: 'mythic', effect: '비행속도1' },
  { id: 'badge35', name: '어스름의 날개깃 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge35.png`, amount: 1, grade: 'mythic', effect: '비행속도2' },
  { id: 'badge36', name: '칠흑의 까마귀 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge36.png`, amount: 1, grade: 'mythic', effect: '비행속도2' },
  { id: 'badge37', name: '대지의 석판 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge37.png`, amount: 1, grade: 'mythic', effect: '블록설치1' },
  { id: 'badge38', name: '장인의 설계서 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge38.png`, amount: 1, grade: 'mythic', effect: '블록설치1' },
  { id: 'badge39', name: '정교한 카드 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge39.png`, amount: 1, grade: 'mythic', effect: '블록설치2' },
  { id: 'badge40', name: '봉인된 시공 고서 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge40.png`, amount: 1, grade: 'mythic', effect: '블록설치2' },
  { id: 'badge41', name: '장대한 석상 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge41.png`, amount: 1, grade: 'mythic', effect: '거인1' },
  { id: 'badge43', name: '영광의 금상 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge43.png`, amount: 1, grade: 'mythic', effect: '거인2' },
  { id: 'badge44', name: '태고의 투구 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge44.png`, amount: 1, grade: 'mythic', effect: '거인2' },
  { id: 'badge45', name: '작은 씨앗 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge45.png`, amount: 1, grade: 'mythic', effect: '요정1' },
  { id: 'badge46', name: '숲의 도토리 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge46.png`, amount: 1, grade: 'mythic', effect: '요정1' },
  { id: 'badge47', name: '작은 고슴도치 친구 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge47.png`, amount: 1, grade: 'mythic', effect: '요정2' },
  { id: 'badge48', name: '요정의 꽃핀 획득권', prob: 0.625, image: `${STORAGE_BASE_URL}/badge/random_badge48.png`, amount: 1, grade: 'mythic', effect: '요정2' },
  { id: 'badge17', name: '날렵한 깃털 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge17.png`, amount: 1, grade: 'rare', effect: '민첩1' },
  { id: 'badge18', name: '민첩한 벌의 날개 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge18.png`, amount: 1, grade: 'rare', effect: '민첩1' },
  { id: 'badge19', name: '청풍의 부채 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge19.png`, amount: 1, grade: 'rare', effect: '민첩2' },
  { id: 'badge20', name: '활강의 가속 망토 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge20.png`, amount: 1, grade: 'rare', effect: '민첩2' },
  { id: 'badge21', name: '거친 도끼 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge21.png`, amount: 1, grade: 'rare', effect: '파괴력1' },
  { id: 'badge22', name: '무거운 곡괭이 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge22.png`, amount: 1, grade: 'rare', effect: '파괴력1' },
  { id: 'badge23', name: '암흑의 낫 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge23.png`, amount: 1, grade: 'rare', effect: '파괴력2' },
  { id: 'badge24', name: '적황의 곡괭이 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge24.png`, amount: 1, grade: 'rare', effect: '파괴력2' },
  { id: 'badge7', name: '치유의 고리 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge7.png`, amount: 1, grade: 'rare', effect: '회복력2' },
  { id: 'badge26', name: '유연한 도마뱀 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge26.png`, amount: 1, grade: 'rare', effect: '낙법1' },
  { id: 'badge27', name: '완충의 꽃잎 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge27.png`, amount: 1, grade: 'rare', effect: '낙법2' },
  { id: 'badge28', name: '봄빛의 발찌 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge28.png`, amount: 1, grade: 'rare', effect: '낙법2' },
  { id: 'badge29', name: '유영의 물약 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge29.png`, amount: 1, grade: 'rare', effect: '수영 속도1' },
  { id: 'badge30', name: '바다 거북이 등껍질 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge30.png`, amount: 1, grade: 'rare', effect: '수영 속도1' },
  { id: 'badge31', name: '청해의 반지 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge31.png`, amount: 1, grade: 'rare', effect: '수영 속도2' },
  { id: 'badge32', name: '해류의 문장 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge32.png`, amount: 1, grade: 'rare', effect: '수영 속도2' },
  { id: 'badge1', name: '순환의 생명 물약 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge1.png`, amount: 1, grade: 'rare', effect: '체력1' },
  { id: 'badge2', name: '견고한 바위 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge2.png`, amount: 1, grade: 'rare', effect: '체력1' },
  { id: 'badge3', name: '생기로운 청과 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge3.png`, amount: 1, grade: 'rare', effect: '체력2' },
  { id: 'badge4', name: '만개한 꽃병 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge4.png`, amount: 1, grade: 'rare', effect: '체력2' },
  { id: 'badge5', name: '싱그러운 새싹 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge5.png`, amount: 1, grade: 'rare', effect: '회복력1' },
  { id: 'badge6', name: '붉은 장미꽃 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge6.png`, amount: 1, grade: 'rare', effect: '회복력1' },
  { id: 'badge8', name: '무지개빛 생화 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge8.png`, amount: 1, grade: 'rare', effect: '회복력2' },
  { id: 'badge9', name: '청빛의 결정 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge9.png`, amount: 1, grade: 'rare', effect: '점프력1' },
  { id: 'badge10', name: '바람의 깃털 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge10.png`, amount: 1, grade: 'rare', effect: '점프력1' },
  { id: 'badge25', name: '착지의 지팡이 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge25.png`, amount: 1, grade: 'rare', effect: '낙법1' },
  { id: 'badge11', name: '영롱한 나비 날개 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge11.png`, amount: 1, grade: 'rare', effect: '점프력2' },
  { id: 'badge12', name: '비상의 상징 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge12.png`, amount: 1, grade: 'rare', effect: '점프력2' },
  { id: 'badge13', name: '초심의 검 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge13.png`, amount: 1, grade: 'rare', effect: '공격력1' },
  { id: 'badge14', name: '자연의 검 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge14.png`, amount: 1, grade: 'rare', effect: '공격력1' },
  { id: 'badge15', name: '찬란한 금검 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge15.png`, amount: 1, grade: 'rare', effect: '공격력2' },
  { id: 'badge16', name: '서리의 날 획득권', prob: 2.8125, image: `${STORAGE_BASE_URL}/badge/random_badge16.png`, amount: 1, grade: 'rare', effect: '공격력2' },
];
    ...
    <div className="w-full space-y-6 relative transition-colors duration-300">
      ...
      <div className="bg-white dark:bg-[#111] border border-gray-200 dark:border-white/10 rounded-[2rem] p-5 max-w-5xl mx-auto mt-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-base font-black text-fuchsia-600 dark:text-fuchsia-400">랜덤 뱃지 보급품 확률표</h3>
        </div>
          ...
          {BADGE_REWARDS.map((item, idx) => (
            <div key={idx} className="group relative hover:z-50 flex items-center gap-3 bg-gray-50 dark:bg-white/5 p-3 rounded-xl border border-gray-100 dark:border-white/5 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors cursor-default">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[11px] text-gray-500 dark:text-gray-400 mt-1">{item.effect}</div>
              </div>
