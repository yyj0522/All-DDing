        ...
        <div className="flex items-center gap-3">
          {mode === 'normal' && (
            <div className="flex items-center gap-2 mr-2">
              ...
              <label htmlFor="anim" className="text-sm font-bold text-gray-600 dark:text-gray-300 cursor-pointer select-none hover:text-gray-900 dark:hover:text-white transition-colors">룰렛 켜기</label>
            </div>
          )}
